...
var Fonts = (function () {
  ...
  _createClass(Fonts, null, [{
    ...
    value: function checkFont(font, callback) {
      ...
      if (Fonts.browserDefaults.hasLoadingWidth && width !== Fonts.browserDefaults.loadingWidth && width !== Fonts.browserDefaults.customWidth) {
    ...
    value: function loadFonts(fonts, callback, errback) {
      ...
      for (var i = 0, len = fonts.length; i < len; i++) {
        Fonts.loadFont(fonts[i], function () {
          if (! --count) {
      ...
      if (USE_FONTS_API && document.fonts && window.FontFace) {
        ...
        var _ret = (function () {
          ...
          var load = function load() {
            ...
            var fontUrl = Fonts.parseUrlSrc(font.urlSrc[index++]);
